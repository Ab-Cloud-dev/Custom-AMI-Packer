...
variable "ssh_keypair_name" {
  type    = string
  default = "key" # Replace with your AWS key pair name
}

variable "ssh_private_key_file" {
  type    = string
  default = "/home/ubuntu/pack/key.pem" # Path to your .pem file
}
...
build {
  ...
  provisioner "ansible" {
    playbook_file          = "/ansible/playbook.yml" # Path to your ansible playbook
    user                   = "ubuntu"
    use_proxy              = false
